...
final_score = (0.30 * entropy_score + 0.20 * length_score + 0.20 * category_score + 0.15 * chromatic_score + 0.10 * edge_score + 0.05 * collision_score)

strength_percent = final_score * 100
...
#--------------------------------------------------------------------------#
#Radar Chart
labels = ["Entropy", "Category", "Chromatic", "Transition", "Collision"]
stats = [entropy_score, category_score, chromatic_score, edge_score, collision_score]
num_vars = len(labels)
